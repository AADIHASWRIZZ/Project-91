...
function car1_down()
{
	...
	{
		car1_y = car1_y + 10;
		console.log("When down arrow is presses, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_left()
{
	...
	{
		car1_x = car1_x - 10;
		console.log("When left arrow is presses, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car1_right()
{
	...
	{
		car1_x = car1_x + 10;
		console.log("When right arrow is presses, x = " + car1_x + " | y = " +car1_y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
